package tech.odes.object.storage.s3;
...
public class XferMgrProgress {
    ...
    private static Log LOG = LogFactory.getLog(XferMgrProgress.class);
    ...
    public static void printProgressBar(double pct) {
        ...
        LOG.info(String.format("  [%s%s]", filled_bar.substring(0, amt_full), empty_bar.substring(0, bar_size - amt_full)));
    }
    ...
    public static void main(String[] args) {
        ...
        if (f.exists() == false) {
            LOG.info("Input path doesn't exist: " + args[cur_arg]);
